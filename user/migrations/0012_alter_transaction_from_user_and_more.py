...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('user', '0011_alter_user_uid_transaction'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='from_user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='outcome', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AlterField(
            model_name='transaction',
            name='to_user',
